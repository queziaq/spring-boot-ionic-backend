...
public class DBService {
	...
	public void instantiateTest() throws ParseException {
		...
		Produto p9 = new Produto(null, "Luminaria", 180.00);
		...
		Cliente cli1 = new Cliente(null, "Quezia Abrahao", "quirinoquezia@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,ps.encode("123"));
